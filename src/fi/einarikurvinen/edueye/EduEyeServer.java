...
public class EduEyeServer extends NanoHTTPD
{
    static final String TAG="CHGT";
    
    public EduEyeServer(int port, Context ctx) throws IOException {
        super(port, ctx.getAssets());
    }
    
    public EduEyeServer(int port, String wwwroot) throws IOException {
